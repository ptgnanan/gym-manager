  ...
  <el-dialog v-model="visible" :title="title" width="620px">
    <el-form :model="form" label-width="90px">
      <el-row :gutter="16">
        ...
        <el-col :span="12"><el-form-item label="器材分类"><el-input v-model="form.category" /></el-form-item></el-col>
...
const form = { equipmentNo: 'EQ-003', name: '', category: '', quantity: 1, location: '', status: '正常' }
